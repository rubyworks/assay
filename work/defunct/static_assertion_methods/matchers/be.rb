require 'assay/nomenclature/hander/should'

module Assay

  module Nomenclature

    # Be Matchers provide a set of RSpec-compatible matcher methods.
    # These matchers provide all the traditional Rspec matchers, less
    # a bit of extraneous verbosity, plus a few additional matchers.
    #
    module Be
